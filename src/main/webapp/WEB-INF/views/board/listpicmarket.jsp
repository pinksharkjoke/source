				...
				<div class="page-blog">
					...
					<main id="main">
						...
						<div class="breadcrumbs d-flex align-items-center"
							style="background-image: url('${contextPath}/resources/test/img/marketimage.jpg'); background-size:cover;">
							<div style="color: white; " >Image by pikisuperstar on
								Freepik</div>
							<div
						...
						<div style="margin-top: 40px">
							<a href="${contextPath}/board/listpicmarket?ca=${type}"><button
									...
									style="margin-left: 55px">전체보기</button> </a> <a
								href="${contextPath}/board/listing?ca=${type}"><button
									id="ing" name="ing" class="btn btn-success"
									style="margin-left: 10px">판매중</button></a>
							<button type="button"
								onclick="location.href='/pap/board/listpicmarket?ca=${scri.ca_num}&searchType=${scri.searchType}&keyword=${scri.keyword}&sort=viewCount'"
								class="btn btn-outline-dark float-right ">조회순</button>
							<button type="button"
								onclick="location.href='/pap/board/listpicmarket?ca=${scri.ca_num}&searchType=${scri.searchType}&keyword=${scri.keyword}&sort=likeCount'"
								class="btn btn-outline-dark float-right" data-bs-toggle="button">좋아요순</button>
							<button type="button"
								onclick="location.href='/pap/board/listpicmarket?ca=${scri.ca_num}&searchType=${scri.searchType}&keyword=${scri.keyword}&sort=bno'"
													...
													<article class="d-flex flex-column">
														...
														<div class="post-img">
															<div class="post-img">
																...
																<img src="${board.bo_photo}" class="img-fluid"
																	style="width: 500px">
										...
										<div>
											<ul>
												<c:if test="${pageMaker.prev}">
													<li><a
														href="listpicmarket${pageMaker.makeSearch(pageMaker.startPage - 1)}">이전</a></li>
												</c:if>

												<c:forEach begin="${pageMaker.startPage}"
													end="${pageMaker.endPage}" var="idx">
													<li><a
														href="listpicmarket${pageMaker.makeSearch(idx)}">${idx}
													</a>&nbsp;</li>
												</c:forEach>

												<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
													<li><a
														href="listpicmarket${pageMaker.makeSearch(pageMaker.endPage + 1)}">다음</a></li>
												</c:if>
									...
									<div class="col-lg-4" data-aos="fade-up" data-aos-delay="400">
										...
										<div class="sidebar ps-lg-4">
											...
											<div class="sidebar-item categories">
												...
												<ul class="mt-3">
													<a href="${contextPath}/board/listpicmarket?ca=301">▶사료/간식</a>
													<br>
													<a href="${contextPath}/board/listpicmarket?ca=302">▶위생/미용용품</a>
													<br>
													<a href="${contextPath}/board/listpicmarket?ca=303">▶하우스/실내용품</a>
													<br>
													<a href="${contextPath}/board/listpicmarket?ca=304">▶리드줄/야외용품</a>
													<br>
													<a href="${contextPath}/board/listpicmarket?ca=305">▶장난감/훈련용품</a>
													<br>
													<a href="${contextPath}/board/listpicmarket?ca=306">▶의류/악세서리</a>
													<br>
													<a href="${contextPath}/board/listpicmarket?ca=307">▶급수/급식기</a>
												</ul>
											</div>
												...
												<c:forEach var="board" items="${listRecent }">
													...
													<div class="mt-3">
														...
														<div class="post-item mt-3">
															...
															<img src=${board.bo_photo } style="float: right;" />
															<div>
																<h4>
