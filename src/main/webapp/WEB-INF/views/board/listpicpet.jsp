				...
				<!-- End Header -->
					...
					<main id="main">
						...
						<div class="breadcrumbs d-flex align-items-center"
							style="background-image: url('${contextPath}/resources/test/img/pet.jpg'); background-size:auto;">
							<div
				...
				<div style="background-color: #C3E7FA;">
					...
					<div style="margin-top: 40px">
							<button type="button"
								...
								class="btn btn-outline-dark float-right " style="margin-left: 200px">조회순</button>
							<button type="button"
														...
														<ul>
															...
															<li class="d-flex align-items-center"><i
																...
																href="detail?num=${board.bo_num }"><time
																		datetime="01-01">${board.bo_modifydate }</time></a></li>
															<li class="d-flex align-items-center"><i
																class="bi bi-eye"></i>${board.bo_views } <a
																href="detail?num=${board.bo_num }"> </a></li>
															<li class="d-flex align-items-center"><i
																class="bi bi-chat-dots"></i>${replyCount[status.index] }<a
																href="detail?num=${board.bo_num }"> </a></li>
															<li class="d-flex align-items-center"><i
									...
									<div>
										<ul>
											<c:if test="${pageMaker.prev}">
												<li><a
													href="listpicpet${pageMaker.makeSearch(pageMaker.startPage - 1)}">이전</a></li>
											</c:if>

											<c:forEach begin="${pageMaker.startPage}"
												end="${pageMaker.endPage}" var="idx">
												<li><a href="listpicpet${pageMaker.makeSearch(idx)}">${idx}</a>
													&nbsp;</li>
											</c:forEach>

											<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
												<li><a
													href="listpicpet${pageMaker.makeSearch(pageMaker.endPage + 1)}">다음</a></li>
											</c:if>
								...
								<div class="col-lg-4" data-aos="fade-up" data-aos-delay="400">
									...
									<div class="sidebar ps-lg-4">
										...
										<div class="sidebar-item categories">
											...
											<ul class="mt-3">
												<a href="${contextPath}/board/listpicpet?ca=101">▶강아지(Dog)</a>
												<Br>
												<a href="${contextPath}/board/listpicpet?ca=102">▶고양이(Cat)</a>
												<Br>
												<a href="${contextPath}/board/listpicpet?ca=103">▶기타(Etc)</a>
											</ul>
										</div>
											...
											<c:forEach var="board" items="${listRecent }">
												...
												<div class="mt-3">
													...
													<div class="post-item mt-3">
														...
														<a href="detail?num=${board.bo_num }">
														<img
															src=${board.bo_photo } /></a>
														<div>
															<h4>
