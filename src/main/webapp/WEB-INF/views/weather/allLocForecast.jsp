...
<link href="https://fonts.googleapis.com/css?family=Varela+Round"
	rel="stylesheet" />
<link href="${contextPath }/resources/weather/css/styles.css"
	rel="stylesheet" />
					<link rel="shortcut icon" href="${contextPath }/resources/weather/assets/favicon.ico">
		...
		<div id="layoutSidenav_content">
			<main>
				<head>
					...
					<%@ include file="../include/allGeoData.jsp"%>
				</head>
				<body>
					<svg class="hidden">
						<defs>
					...
					<header class="codrops-header">
						<div class="codrops-header__main">
							<div class="codrops-links">
								<a class="codrops-icon codrops-icon--prev" href="${contextPath }/weather/home" title="이전화면"><svg class="icon icon--arrow">
								<use xlink:href="#icon-arrow"></use></svg></a>
								<a class="codrops-icon codrops-icon--drop" href="https://www.weather.go.kr/w/index.do" title="우리나라 기상청"><svg class="icon icon--drop">
								<use xlink:href="#icon-drop"></use></svg></a>
							</div>
							<h1 class="codrops-header__title">전국날씨</h1>
						</div>
